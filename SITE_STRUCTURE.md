...
│   │   ├── kw-mail-assist-v1.6.1.zip                             # メールアシスト for kintone 配布ファイル（最新・手動配置・v1.6.1 表示・送信条件でユーザーを選ぶとき、停止中の利用者を候補に出さない。設定済みのものは「停止中」と表示して残す）
