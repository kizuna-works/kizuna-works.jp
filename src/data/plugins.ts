...
export const plugins: Plugin[] = [
  ...
  },
  {
    ...
    category: '入力支援',
    description:
      'ルックアップに、入力中の候補をその場で表示するライブサジェスト機能を追加するプラグイン。別画面に切り替える手間がなくなり、電話番号・住所など複数フィールドの横断検索で同名顧客の取り違えも防げます。サブテーブル内のルックアップとスマホにも対応。',
    ...
    price: 0,
    cardDescription:
      'ルックアップフィールドへの入力中に候補を直下表示。画面遷移なしで取得まで完結。スマホ対応。',
