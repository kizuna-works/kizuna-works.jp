...
export const plugins: Plugin[] = [
  ...
  },
  {
    ...
    description:
      '区分・ステータス・入力値や対象ユーザーの条件で、フィールドの表示/非表示・必須化・読み取り専用・自動入力・選択肢の絞り込みを切り替え。保存・承認・削除の前に止める・確認する・その場で入力させることもでき、モバイルでも動作します。',
    ...
    price: 0,
    cardDescription:
      '条件でフィールドの表示/非表示・必須化・読み取り専用・自動入力・選択肢の絞り込みを制御。保存・承認・削除の前に止める・確認もでき、モバイルでも動作します。',
