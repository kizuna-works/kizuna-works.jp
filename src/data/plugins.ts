...
export const premiumPlugins: Plugin[] = [
  ...
  },
  {
    ...
    categories: ['自動入力'],
    description:
      'あらかじめ登録した「値のセット」を選ぶだけで、複数フィールドとテーブル明細をまとめて入力できるプラグイン。日付は「本日」、担当者は「ログインユーザー」で持てます。管理者が作る共通と、各ユーザーが詳細画面から作る個人テンプレートの2階層。',
    ...
    tier: 'premium',
    cardDescription:
      '登録した値のセットを選ぶだけで複数フィールドとテーブル明細を一括入力。日付は「本日」、担当者は「ログインユーザー」で持てる。共通と個人の2階層。',
