...
export const plugins: Plugin[] = [
  ...
  },
  {
    ...
    categories: ['自動入力'],
    description:
      'ユーザー選択フィールドで選んだ人（新規作成時は自分）の組織・役職・メール・社員番号などを対応フィールドへ自動転記。組織・グループは選択値でセット。プロフィールカードや承認欄の捺印をスペースに表示し、印刷・PDF出力にも出せます。',
    ...
    price: 0,
    cardDescription:
      'ユーザー選択で選んだ人の組織・役職・社員番号などを自動転記（組織/グループは選択値セット）。プロフィールカードや承認欄の捺印は印刷・PDFにも出力。',
    problemTitle: '担当者の部署・連絡先を毎回手入力・承認欄を手書きしている',
    problemDesc: '日報や申請で報告者＝自分の部署・役職・連絡先を毎回調べて入力し、組織は文字列でばらつき、承認欄は手書きやハンコで運用している。印刷して回すと承認欄が空欄のまま出てくる',
