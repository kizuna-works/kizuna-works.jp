...
export const premiumPlugins: Plugin[] = [
  {
    ...
    categories: ['出力・帳票'],
    description:
      'お手持ちのPDFや白紙の用紙にレコード値・明細・ロゴをドラッグ配置して帳票化。決裁欄の印影は1クリックで置き、様式の押印枠に自動で合わせます。印刷ボタンは操作している人で出し分け、帳票が多いときは色分けボタンから選択。実データの印刷プレビュー付き。',
    ...
    tier: 'premium',
    cardDescription:
      '手持ちの PDF に kintone のデータをドラッグ配置して帳票化。決裁欄の印影も 1 クリックで置け、印刷ボタンは操作している人で出し分けできます。',
    problemTitle: '既存の PDF 帳票に kintone のデータを流し込みたい／押印欄や一覧表もそのまま出したい',
    problemDesc: '請求書・見積書・稟議書を作り直さず 1 件ずつ印刷したい。申請書の押印欄に承認者の印影と押印日を入れたい。人によって出せる帳票を変えたい。帳票が増えてドロップダウンから選びにくい。絞り込んだ一覧を 1 枚の表にして印刷したい',
