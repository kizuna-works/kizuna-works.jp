...
export const plugins: Plugin[] = [
  ...
  },
  {
    ...
    description:
      '区分・ステータス・入力値や対象ユーザーの条件で、フィールドの表示/非表示・必須化・読み取り専用・自動入力・選択肢の絞り込みを切り替え。保存・承認・削除の前に条件を判定し、止める・確認する・不足項目をその場で入力させることもできます。',
    ...
    price: 0,
    cardDescription:
      '条件でフィールドを表示/非表示・必須化・読み取り専用・自動入力・選択肢の絞り込みに制御。保存・承認・削除の前に止める・確認する・その場で入力させることもできます。',
