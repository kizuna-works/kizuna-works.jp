...
export const premiumPlugins: Plugin[] = [
  {
    ...
    categories: ['出力・帳票'],
    description:
      'お手持ちのPDFや白紙の用紙にレコード値・明細・ロゴをドラッグ配置して帳票化。別々のテーブルの明細を1枚に上下・左右で並べられ、他のアプリで作った帳票も取り込めます。決裁欄の印影は1クリックで配置、印刷ボタンは操作している人で出し分け。実データの印刷プレビュー付き。',
    ...
    tier: 'premium',
    cardDescription:
      '手持ちの PDF に kintone のデータをドラッグ配置して帳票化。別々のテーブルの明細を 1 枚に並べられ、他のアプリで作った帳票も取り込めます。決裁欄の印影も 1 クリックです。',
    problemTitle: '既存の PDF 帳票に kintone のデータを流し込みたい／明細が複数ある帳票や一覧表もそのまま出したい',
    problemDesc: '請求書・見積書・稟議書を作り直さず 1 件ずつ印刷したい。商品明細と作業明細のように表が 2 つある帳票を 1 枚に収めたい。別のアプリで作った様式を作り直さず使い回したい。申請書の押印欄に承認者の印影と押印日を入れたい。人によって出せる帳票を変えたい。絞り込んだ一覧を 1 枚の表にして印刷したい',
  ...
  },
  {
    ...
    description:
      '添付PDFに押印画像・手書き・テキスト・図形9種・矢印をその場で書き加えて保存。スマホ対応で、画面いっぱいに書いたサインを署名欄へ収めるサイン専用モードつき。白塗りでは残る情報はページを焼き直して物理削除する墨消し、原本を残す世代管理、パスワード付きPDFにも対応。',
    ...
    tier: 'premium',
    cardDescription:
      '添付PDFに押印・手書き・テキスト・図形をその場で書き加えて保存。スマホでは画面いっぱいに書いたサインを署名欄へ収められます。白塗りでは残る情報を焼き直して本当に消す墨消しつき。',
    problemTitle: '添付PDFへの押印や現場でのサインのたび、kintoneの外へ出ている',
    problemDesc: '押印のために印刷してスキャンし直している。現場でお客様の署名をもらうのに確認書を紙で持ち出している。図面の指示は文字では伝わらない。金額や個人情報を白く塗って隠したつもりでも、元の文字はファイルに残っている',
