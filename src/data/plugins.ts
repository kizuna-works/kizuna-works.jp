...
export const plugins: Plugin[] = [
  ...
  },
  {
    ...
    description:
      '区分・ステータス・入力値やルックアップ、対象ユーザーの条件で、フィールドの表示/非表示・必須化・読み取り専用・値の自動入力・選択肢の絞り込みを切り替え。サブテーブル・関連レコード一覧の制御や「いずれか」「以外」の複数値条件にも対応。',
    ...
    price: 0,
    cardDescription:
      '区分・ステータス・入力値・ルックアップ・対象ユーザーの条件で、フィールドを表示/非表示・必須化・読み取り専用・自動入力・選択肢の絞り込みに動的制御。',
