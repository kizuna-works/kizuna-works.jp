...
export const premiumPlugins: Plugin[] = [
  ...
  },
  {
    ...
    description:
      'ユーザー選択・組織選択・グループ選択フィールドの候補を、役職・所属・他フィールドの値・ステータスで自動的に絞り込むプラグイン。候補外の値は保存時にブロックでき、条件が変われば自動で外せます。↑↓とEnterのキーボード操作、サブテーブルにも対応。',
    ...
    tier: 'premium',
    cardDescription:
      'ユーザー・組織・グループ選択の候補を、役職や申請種別などの条件で自動的に絞り込み。候補外の値は保存時にブロックでき、キーボードで素早く選択。',
    problemTitle: '担当者や申請先を、部署外まで含めた全員から選ばせたくない',
    problemDesc:
      '申請先組織や承認者を、役職・所属・申請種別に応じた候補だけに絞り、候補外の人が入ったまま保存されるのも防ぎたい',
