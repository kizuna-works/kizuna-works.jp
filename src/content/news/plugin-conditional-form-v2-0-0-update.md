...
これまでの条件（区分・ステータス・入力値）に加えて、<strong>「誰が操作しているか」</strong>でルールの適用を切り替えられるようになりました。ルールごとに **特定のユーザー・組織・グループ** を指定でき、そのアカウントで開いたときだけ、表示／非表示・必須化・読み取り専用・自動入力・選択肢の絞り込みを働かせられます。
