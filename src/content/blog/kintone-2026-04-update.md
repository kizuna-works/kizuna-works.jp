...
![kintone 2026年4月アップデートの全体概要](/images/blog/kintone-2026-04-update.png)
...
これらの課題を解決するために、自社のニーズに合わせて以下のようなプラグインを組み合わせて導入することを検討してみましょう。
...
| 条件分岐自動採番プラグイン | 事業部や入力内容に応じて「AD-00001」「BD-00001」といった異なるフォーマットの採番を自動で行う | 標準機能では実現不可能な複雑なルールに基づく連番付与を、ノーコードで確実に実行する |
