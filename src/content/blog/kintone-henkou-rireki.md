---
title: "kintone変更履歴の見方とCSV出力の可否｜監査ログとの違い・保存期間【2026年版】"
description: "kintoneの変更履歴はレコード詳細画面の［変更履歴］から確認します。CSVには書き出せず取得用のREST APIも公開されていない点、保存期間と非表示設定、監査ログ・ステータス履歴との使い分け、標準では残らない「誰が見たか」を記録する方法まで実務目線で整理します。"
pubDate: 2026-07-25
author: "KIZUNA Works"
