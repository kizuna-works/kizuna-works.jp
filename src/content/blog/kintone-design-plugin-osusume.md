...
KIZUNA Worksでは、フィールドのスタイル変更に特化した「[フィールドスタイラー](/plugins/field-styler/)」と、罫線とスペースの装飾に特化した「[FormDeco](/plugins/form-deco/)」の2つのプラグインを完全無料で公開しています。フィールド単位の装飾には**フィールドスタイラー**を、画面全体の構造を整える罫線・スペースの装飾には**FormDeco**を、と使い分けたり組み合わせたりすることで、kintoneの見た目を低コストで大きく改善できますので、ぜひ自社のアプリに導入してみてくださいね！
