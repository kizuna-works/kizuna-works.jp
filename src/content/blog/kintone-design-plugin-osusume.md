...
つまり標準でできるのは**「並べ方の整理」まで**で、**「見た目の強調」には踏み込めません**。ここから先がプラグインの領分です。
...
装飾以外のプラグインも探している場合は、[kintone無料プラグインのおすすめ｜やりたいこと別の選び方](/blog/kintone-muryou-plugin-osusume/)で、一覧・検索・集計・入力といった用途ごとに候補を整理しています。製品の仕様を直接確かめたいときは[kintoneプラグイン一覧](/plugins/)からどうぞ。
