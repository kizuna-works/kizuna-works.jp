...
なお、kintoneの帳票出力全体の進め方（標準印刷・無料の方法・プラグイン）を先に俯瞰したい方は、[kintone帳票出力・PDF出力の完全ガイド](/blog/kintone-cyouhyou-pdf-output/)にまとめています。まず無料の範囲で試したい方はそちらから。本記事は、その先で本格的にプラグイン導入を検討する方に向けた**製品比較**のガイドです。
...
### ReportsConnect for kintone：3ページまでずっと無料 スモールスタートの強い味方

株式会社ケーピーエスが提供する「[ReportsConnect for kintone](https://kintone-sol.cybozu.co.jp/integrate/kps001.html)」は、3ページまでのPDF出力であれば、期間や回数の制限なく「無料」で利用できるという強力な特徴を持っています。一括出力やAI設定などの高度な機能はありませんが、「月に数回、簡単な見積書をPDF化できれば十分」という小規模な利用シーンには最適です。
...
### 帳票デザイナー for kintone：手持ちのPDFを背景に、無料から始められる

KIZUNA Worksが提供する「帳票デザイナー for kintone」は、使い慣れた請求書・見積書のPDFをそのまま背景として取り込み、その上にkintoneの項目をドラッグで配置して帳票化するプラグインです。既存のフォーマットを作り直す必要がない点が大きな特徴と言えます。

明細の自動繰り返し・自動改ページ、ロゴや印影（透過PNG）の配置、PDFの添付フィールドへの自動保存に対応しています。レコード詳細からの1件印刷であれば、テンプレート1件まで無料で利用可能です。複数テンプレートや一覧からのまとめ印刷、集計表紙などの全機能は、プレミアム年間サポーター（税込 ¥16,500/年）で解放され、KIZUNA Worksが販売する全プラグインも対象になります。

今使っているフォーマットを活かしてスモールスタートしたい場合に向いています。設定手順は[kintoneの帳票を“今の書式のまま”出力する方法](/blog/kintone-cyouhyou-sonomama/)で詳しく解説しています。
...
<a href="https://px.a8.net/svt/ejp?a8mat=4B1RXQ+3YAMCY+2ZJ4+60H7L" rel="nofollow">Misoca（ミソカ）- クラウド見積書・請求書作成サービス</a>
<img border="0" width="1" height="1" src="https://www14.a8.net/0.gif?a8mat=4B1RXQ+3YAMCY+2ZJ4+60H7L" alt="">
...
- 今使っているExcel・PDFのフォーマットを作り直さず、無料から帳票化を試したいなら「**帳票デザイナー for kintone**」も選択肢になります。
...
- [kintoneの帳票を“今の書式のまま”出力する方法](/blog/kintone-cyouhyou-sonomama/) — 手持ちのPDFを背景にドラッグ配置で帳票化する手順
- [帳票デザイナー for kintone](/plugins/report-designer/) — 手持ちのPDFを背景に項目を配置して帳票化（無料プランあり）
